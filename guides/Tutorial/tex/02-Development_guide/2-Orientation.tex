...
\begin{center}
    \begin{tikzpicture}[node distance=1.5cm]
        ...
        \node (add_dictionary) [process, below of=if_no_parameter, align = center, yshift=-2cm] {HDF5\_BLS.wrapper.py -> Wrapper.add\_data\_dictionary};
        ...
        \draw [arrow] (if_no_parameter) -- node[anchor=east] {No} (add_dictionary);
        \draw [arrow] (wrong_creator) -- (if_no_parameter);
        \draw [arrow] (wrong_parameters) |- (add_dictionary);
