...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance=2cm]
        ...
        \node (raiseError3) [startstop, below of=iterateKeys, yshift=-2cm, xshift=-1cm, align=center] {WrapperError\_Overwrite};
        ...
        \node (raiseError4) [startstop, left of=addAbscissa, xshift=-3cm, align=center] {WrapperError\_AttributeError};
        ...
        \draw [arrow] ++(iterateKeys.south) |- +(-1cm,-0.5cm) -| node[anchor=west, yshift=0cm, xshift=0cm, align=center] {else} (nameOverwrite.north);
        ...
        \draw [arrow] (addData) -- node[anchor=west, align=center, yshift=-0.5cm] {dictionary element is dict\\ with key "Abscissa\_..."} (addAbscissa);
        \draw [arrow] ++(addData.south) |- +(0cm, -1cm) -| node[anchor=west, align=center, yshift=-1cm] {dictionary element\\ is other} (raiseError4.north);
        \draw [arrow] ++(nameOverwrite.south)|- +(0cm, -2.3cm) -|  (addAbscissa.north);
        \draw [arrow] ++(addData.south) |- +(0cm, -1cm) -| node[anchor=north, align=center, xshift=2.5cm, yshift=0cm] {dictionary element is dict\\ with key in "Raw\_data", "PSD",\\"Frequency", "Shift", "Shift\_std"\\ "Linewidth" or "Linewidth\_std"} (addNormal.north);
