...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance=2cm]
        ...
        \draw [arrow] ++(addData.south) |- +(0cm, -1cm) -| node[anchor=north, align=center, xshift=2.5cm, yshift=0cm] {element is dict\\ with key in "Raw\_data", "PSD",\\"Frequency", "Shift", "Shift\_err"\\ "Linewidth", "Linewidth\_err" \\ or "Other"} (addNormal.north);
