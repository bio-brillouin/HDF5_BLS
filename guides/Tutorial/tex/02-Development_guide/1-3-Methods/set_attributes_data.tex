This method allows the user to update the attributes of the wrapper with the values of a dictionnary. This is the preferred way to update the attributes of a group or dataset of the HDF5 file.
