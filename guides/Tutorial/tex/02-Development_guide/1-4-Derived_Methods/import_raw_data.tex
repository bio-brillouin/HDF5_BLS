This method allows the user to import raw data to the HDF5 file. It adds the data by calling the \hyperref[subsec:wrapper.add_raw_data]{Wrapper.add\_raw\_data} method.
