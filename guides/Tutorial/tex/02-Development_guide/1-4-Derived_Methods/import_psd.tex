This method allows the user to add a Power Spectral Density array to the HDF5 file from a file. It adds the data by calling the \hyperref[subsec:wrapper.add_psd]{Wrapper.add\_PSD} method.
