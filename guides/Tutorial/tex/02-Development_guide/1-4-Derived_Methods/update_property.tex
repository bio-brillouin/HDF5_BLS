This method allows the user to update one attribute of the wrapper. This method is based on the \hyperref[subsec:wrapper.set_attributes_data]{Wrapper.set\_attributes\_data} method.
